...
export interface PluggyConsentRawRow {
  id: number
  item_id: string
  consent_id: string
...
export function definePluggyConsentRawModel(sequelize: Sequelize) {
  return sequelize.define<Model<PluggyConsentRawRow>>(
    'PluggyConsentRaw',
    {
      ...
      consent_id: { type: DataTypes.STRING(36), allowNull: false },
