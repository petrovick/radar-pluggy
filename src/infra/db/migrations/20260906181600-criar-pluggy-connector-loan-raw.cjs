...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('pluggy_connector_loan_raw', {
    ...
    await queryInterface.addIndex('pluggy_connector_loan_raw', ['item_id', 'loan_id'], {
      name: 'idx_pluggy_connector_loan_raw_item_loan',
    })
  },

  async down(queryInterface) {
    await queryInterface.removeIndex(
      'pluggy_connector_loan_raw',
      'idx_pluggy_connector_loan_raw_item_loan',
    )
    await queryInterface.dropTable('pluggy_connector_loan_raw')
  },
}
