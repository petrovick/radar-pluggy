...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('pluggy_connector_account_transaction_raw', {
    ...
    await queryInterface.addIndex(
      'pluggy_connector_account_transaction_raw',
      ['item_id', 'account_id', 'transaction_id'],
      { name: 'idx_pluggy_connector_account_tx_raw_item_account_tx' },
    )
  },
  ...
  async down(queryInterface) {
    ...
    await queryInterface.dropTable('pluggy_connector_account_transaction_raw')
  },
}
